            ...
            <Form>
                ...
                <Modal.Body>
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control type="text" placeholder="type the name of the project you want to work on"  name={"name"} value={project.name} onChange={editProject}/>
                    </Form.Group>
                    <Form.Group className="mb-3" >
                        <Form.Label>Description</Form.Label>
                        <Form.Control as="textarea" rows={3} placeholder="type a description of the project you want to work on" name={"description"} value={project.description} onChange={editProject} />
                    </Form.Group>
                </Modal.Body>
                <Modal.Footer>
